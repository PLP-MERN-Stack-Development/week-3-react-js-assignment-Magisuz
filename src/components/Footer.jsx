        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold">PLP Task Manager</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              A modern task management application built with React and Tailwind CSS. 
              Organize your life, boost productivity, and achieve your goals with our intuitive interface.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors duration-200"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
